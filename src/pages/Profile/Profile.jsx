              ...
              <div className="notification-options-list">
                <div className="notification-option-row">
                  ...
                  <input 
                    ...
                    checked={isEditing ? !!formData.notifications?.emailAlerts : !!profile.notifications?.emailAlerts}
                    disabled={!isEditing}
                ...
                <div className="notification-option-row">
                  ...
                  <input 
                    type="checkbox" 
                    className="toggle-checkbox"
                    checked={isEditing ? !!formData.notifications?.pushAlerts : !!profile.notifications?.pushAlerts}
                    disabled={!isEditing}
