              ...
              >
                {bookingSuccess ? (
                  <div className="text-center py-6">
                    <FiCheckCircle style={{ fontSize: 48, color: '#10b981', margin: '0 auto 16px' }} />
                    <h3 style={{ fontSize: 20, fontWeight: 700, marginBottom: 8 }}>Booking Request Confirmed!</h3>
                    <p style={{ color: 'var(--text-muted)' }}>
                      Your request for <strong>{selectedService.title || selectedService.name}</strong> has been submitted. A local verified partner will contact you shortly.
                    </p>
                  </div>
                ) : (
                  <>
